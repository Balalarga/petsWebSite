            ...
            <v-layout row wrap justify-space-between>
                <v-col xs="3" sm="3" md="3" lg="3" v-for="pet in petsInfo" :key="pet.id" cols="3" >                
                    <v-item  v-slot="{ active, toggle }" >
                        ...
                        align-self="center"
                        align-items: center
                        class="rounded-circle mb-4 ml-1"
                        dark
                        min-width="150"
                        min-height="150"
                        max-height="150"
...
export default {
  data (){
    return{
      ...
      petsInfo: [
          {name:'a', age:'1', picture:'https://pbs.twimg.com/profile_images/1111666438782312449/DSzHCv1g_400x400.jpg', id:'1'},
